...
DATA_DIR = "/home/mmlab/idl/HW2P2/hw2p2-data/classification/classification/train"
TRAIN_DIR = osp.join(DATA_DIR, "/home/mmlab/idl/HW2P2/hw2p2-data/train_subset/train_subset") # This is a smaller subset of the data. Should change this to classification/classification/train
VAL_DIR = osp.join(DATA_DIR, "/home/mmlab/idl/HW2P2/hw2p2-data/classification/classification/dev")
TEST_DIR = osp.join(DATA_DIR, "/home/mmlab/idl/HW2P2/hw2p2-data/classification/classification/test")
...
#model = Network()
#model = models.convnext_base_in22k()
#model.load_state_dict(torch.load('/home/mmlab/idl/HW2P2/convnext_large_1k_224_ema.pth'), strict=False)

model = timm.create_model("convnext_tiny", pretrained=False)
model.fc = nn.Linear(768, 7000)
print(model)
