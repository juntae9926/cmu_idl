...
class InvertedResidualBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.feature_mixing = nn.Sequential(
            # TODO: Fill this in!
            nn.Conv2d(in_channels, hidden_dim, kernel_size=(1, 1), stride=(1, 1), bias=False),
            nn.BatchNorm2d(hidden_dim, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True),
        ...
        self.spatial_mixing = nn.Sequential(
            # TODO: Fill this in!
            nn.Conv2d(hidden_dim, hidden_dim, kernel_size=(3, 3), stride=stride, padding=(1, 1), groups=hidden_dim, bias=False),
            nn.BatchNorm2d(hidden_dim, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        )
        ...
        self.bottleneck_channels = nn.Sequential(
            # TODO: Fill this in!
            nn.Conv2d(hidden_dim, out_channels, kernel_size=(1, 1), stride=(1, 1), bias=False),
...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, num_classes= 7000):
        ...
        self.stem = nn.Sequential(
            # TODO: Fill this in!
            nn.Conv2d(3, 16, kernel_size=(1, 1), stride=(1, 1), padding=(1, 1), bias=False),
