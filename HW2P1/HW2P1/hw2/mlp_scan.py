...
class CNN_DistributedScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        self.conv1.conv1d_stride1.W = w1[0:48, 0:2].reshape(conv1_W_shape).T
        self.conv2.conv1d_stride1.W = w2[0:4, 0:8].reshape(conv2_W_shape).T
        self.conv3.conv1d_stride1.W = w3.reshape(conv3_W_shape).T
