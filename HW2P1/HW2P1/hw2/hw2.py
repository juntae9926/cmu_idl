...
class CNN(object):
    ...
    def __init__(self, input_width, num_input_channels, num_channels, kernel_sizes, strides,
        ...
        self.convolutional_layers = [Conv1d(num_input_channels, 56, kernel_size=5, stride=1, weight_init_fn= conv_weight_init_fn, bias_init_fn= bias_init_fn), 
            Conv1d(56, 28, kernel_size=6, stride=2, weight_init_fn= conv_weight_init_fn, bias_init_fn= bias_init_fn),
            Conv1d(28, 14, kernel_size=2, stride=2, weight_init_fn= conv_weight_init_fn, bias_init_fn= bias_init_fn)]
