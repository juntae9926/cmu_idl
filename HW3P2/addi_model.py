...
class Network(nn.Module):
    ...
    def __init__(self, hidden_dim = [2048, 512], num_classes = 41): # You can add any extra arguments as you wish
        super(Network, self).__init__()

        self.embedding = ResNet([1, 1], 13)
        self.lstm = nn.LSTM(hidden_dim[0], hidden_dim[1], num_layers=4, dropout=0.5, bidirectional=True)
        self.activation = nn.GELU()
